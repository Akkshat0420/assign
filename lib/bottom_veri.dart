...
class BottomVerification extends StatefulWidget {
  ...
  @override
  _BottomVerificationState createState() => _BottomVerificationState();
}

class _BottomVerificationState extends State<BottomVerification> {
      ...
      child: Column(
        ...
        children: [
          ...
          isLoading
              ...
              : ElevatedButton(
                  onPressed: otpController.text.length == 4 ? verifyOtp : null,
